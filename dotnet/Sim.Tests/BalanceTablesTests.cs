...
namespace RTS.Sim.Tests
{
    ...
    {
        private const string GoodsHeader = "id,base_price,volatility,heat_per_unit,supply\n";
        ...
        {
            Load("food,4,0.25,0.00,Domestic\n",
                "farm,1,10,0,0,food,6\n",
                "laborer,2,1.00,1.0,0.00\n",
                out ValidationReport report);
        ...
        public void Every_problem_is_reported_in_one_pass()
        {
            ...
            Load("food,4,0.25,0.00,Local\niron,12,0.3,0.05,Local\ntimber,6,0.2,0,Local\n",
                "ghost,1,0,0,0,unobtainium,3\n",
                "laborer,2,1.00,1.0,0.00\n",
                out ValidationReport report);
