...
namespace RTS.Content.Registries
{
    ...
    public sealed class BalanceTables
    {
        ...
        public const string MaintenanceFile = "maintenance.csv";
        ...
        private BalanceTables(ConfigRegistry<Good> goods, ConfigRegistry<Building> buildings,
            ...
            TradeAiRules tradeAi, MaintenanceRules maintenance)
        {
            Mob = mob;
            Heat = heat;
            TradeAi = tradeAi;
        ...
        /// <summary>What it costs to keep a building standing (GDD §5.5).</summary>
        public MaintenanceRules Maintenance { get; }
        ...
        public static BalanceTables Load(BalanceSources sources, ValidationReport report)
        {
            ...
            var tables = new BalanceTables(goodRegistry, buildingRegistry, crewRegistry,
                ...
                MaintenanceRules.Load(sources.Maintenance, report));
